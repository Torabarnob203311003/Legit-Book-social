    ...
    return (
        <nav className="bg-[#1A1A1A] rounded-lg  flex justify-between items-center flex-wrap p-3 md:p-5">
            ...
            <div className="flex items-center w-full md:w-auto justify-between md:flex-1">
                ...
                <div className="relative w-full pr-10 md:w-[550px] flex items-center">
                    <input
                        type="text"
                        placeholder="Search..."
            ...
            <div className={`flex gap-4 sm:gap-6 lg:pl-6 md:pl-4  text-gray-300 justify-center md:flex-row flex-col md:justify-start w-full md:w-auto ${isMobileMenuOpen ? "flex" : "hidden"} md:flex lg:hidden xl:flex`}>
